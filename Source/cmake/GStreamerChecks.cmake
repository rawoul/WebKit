    ...
    SET_AND_EXPOSE_TO_BUILD(USE_GSTREAMER TRUE)
      if (USE_GSTREAMER_FULL)
          ...
          if (ENABLE_VIDEO)
              ...
              list(APPEND GSTREAMER_COMPONENTS wayland)
          endif ()
	      ...
	      if (NOT PC_GSTREAMER_WAYLAND_FOUND)
                  message(FATAL_ERROR "Video playback requires the following GStreamer libraries: wayland. Please check your gst-plugins-base installation.")
              endif ()
          endif ()
