...
if (USE_FBX_API)
    list(APPEND WebCore_LIBRARIES
        ${FBXBUS_LIBRARIES}
        ${FBXCONNMAN_LIBRARIES}
        ${MEDIACONTROLLER_LIBRARIES}
    )
    list(APPEND WebCore_SYSTEM_INCLUDE_DIRECTORIES
        ${FBXBUS_INCLUDE_DIRS}
        ${FBXCONNMAN_INCLUDE_DIRS}
        ${MEDIACONTROLLER_INCLUDE_DIRS}
    )
endif ()

if (USE_WPE_VIDEO_PLANE_DISPLAY_DMABUF OR USE_WPE_VIDEO_FOREIGN_SURFACE)
...
if (USE_WPE_VIDEO_FOREIGN_SURFACE)
    list(APPEND WebCore_LIBRARIES ${WAYLAND_LIBRARIES})
    list(APPEND WebCore_SYSTEM_INCLUDE_DIRECTORIES ${WAYLAND_INCLUDE_DIRS})
endif ()
